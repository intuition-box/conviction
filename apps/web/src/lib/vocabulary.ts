export const labels = {
  ...
  dashboardSectionPosts: "My posts",
  dashboardSectionPositions: "My positions",
  dashboardEmptyPosts: "You haven't posted anything yet.",
  dashboardEmptyPositions: "You haven't taken any positions yet.",
  dashboardFilterAll: "All",
  dashboardFilterRoot: "Posts",
  dashboardFilterReplies: "Replies",
  dashboardReplyTo: "Reply to",
  dashboardSupportersTitle: "Supporting holders",
  dashboardOpposersTitle: "Opposing holders",
  dashboardReplyCountTitle: "Replies received",
  dashboardLoadMore: "Load more",
  dashboardLoadingMore: "Loading…",
  dashboardPostsError: "Failed to load posts.",
  dashboardTotalValue: "Current value",
  dashboardPositionLinkPost: "Open related post",
  dashboardPositionsError: "Positions are temporarily unavailable.",
  dashboardStatPosts: "Posts",
  dashboardStatSupports: "Supports received",
  dashboardStatRefutes: "Refutes received",
  dashboardStatSupportsTooltip:
    "Unique wallets supporting at least one of your claims.",
  dashboardStatRefutesTooltip:
    "Unique wallets opposing at least one of your claims.",
  dashboardStatReception: "Avg reception",
  dashboardStatReceptionTooltip:
    "Average support ratio across all your claims. 100% = all supporters, 0% = all opposers.",
  dashboardSectionThemes: "My themes",
  dashboardThemesEmpty: "You haven't tagged your posts with any theme yet.",
  dashboardThemesPartial: "Vote counts unavailable — Intuition is temporarily offline.",
  dashboardThemePostsTooltip: "Posts tagged with multiple themes are counted in each.",
  dashboardSectionTopPosts: "Top posts",
  dashboardSectionEngagement: "Engagement",
  dashboardScoreTooltip: "Score = supporters + opposers + replies received.",
  dashboardEngagementEmpty: "No engagement data yet.",
  dashboardEngagementUnavailable:
    "Engagement ranking unavailable — Intuition is temporarily offline.",
  dashboardEngagementCapNote: "Based on your recent 500 posts.",
} as const;
